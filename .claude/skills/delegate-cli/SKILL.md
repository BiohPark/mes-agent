...
같은 원칙은 **데이터 기밀성**에도 적용된다 — 위임 프롬프트에 사내 구체 내용을 그대로 담아 외부
API로 보내야 할 것 같으면, 자동으로 진행하지 말고 먼저 일반화/스크러빙을 시도하거나 사용자에게
승인을 구한다. 상세: `docs/harness/a2a-cli-delegation.md`의 "데이터 기밀성 / 외부 전송 위험" 절.
